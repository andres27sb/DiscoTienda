...
public class Discotienda
{
    ...
    /**
     * Genera un informe de discos de la discotienda
    ...
    public void generarInformeDiscos() throws FileNotFoundException
    {
    	...
    	for(int i=0; i<discos.size(); i++)
    	{
    		...
    		// escribir los datos del disco con la pluma
    ...
    /**
     * Genera un informe de los discos que son de genero Pop y que su precio es superior a 1000 pesos
     * @throws FileNotFoundException
     */
    public void generarInformeDiscosCostosos()throws FileNotFoundException
    {
    	
    	int generoDisco= 0;
    	int precioDisco= 0;
    	
    	String generoIngresado = JOptionPane.showInputDialog("Señor usuario ingrese el genero de musica");
    	...
    	for(int i=0; i<discos.size(); i++) 
    	{
    		...
    		//extrae la informacion guardada del disco y la compara con el genero ingresado por el usuario
    		if(miDisco.darGenero().equals(generoIngresado))
    		{
    			generoDisco++;
    			
    			//verifica que el precio del disco sea superior a 1000 pesos
    	...
    	//
    	if (generoDisco>0 && precioDisco>0)
    	{
    		JOptionPane.showMessageDialog(null, "El disco se encontro :)");
    	}
    	else if (generoDisco==0 || precioDisco==0) {
    		JOptionPane.showMessageDialog(null, "El disco no se encontro :c");
		}
    	// cerrar pluma
    	pluma.close();
    }
    ...
    public String metodo2( )
    {
    	...
    	try {
 			generarInformeDiscosCostosos();
 			return "Reporte de discos costosos generado correctamente !";
 		} catch (FileNotFoundException e) {
 			// devolver el posible error
 			return "Error fatal :-( " + e.getMessage();
